...
from .views import index, getWeather, getParks, user_info, favorites, upload_gpx, get_gpx, ObtainTokenPairWithClaims, CustomUserCreate, LogoutAndBlacklistRefreshTokenForUserView
...
urlpatterns = [
    ...
    path("user/gpx/getAll/", get_gpx, name='get_gpx'),
